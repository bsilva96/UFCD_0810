...
//
//void main() {
//	//declarar variaveis baseadas em estruturas
//	//e cada uma tem de ter pelo a possibilidade de armazenar
//	//até 3 registos
//	struct Carro registos_carros[3];
//	struct Produto registos_produtos[3];
//
//	////inserir 3 registos de carros com uma estrutura 
//	//// de repetição FOR
//	//for(int i = 0; i < 3; i++){
...
//
//	//	printf("Insira o cor do carro: ");
//	//	scanf("%s", registos_carros[i].cor);
//	//}
//
//	////estrutura de repeticao FOR para ler a informação
//	//for (int i = 0; i < 3; i++) {
//	//	printf("*** Registo %d ***\n", i);
...
//	}
//
//	//estrutura de repeticao FOR para ler os produtos
//	for (int i = 0; i < 3; i++) {
//		printf("*** Registo %d ***\n", i);
